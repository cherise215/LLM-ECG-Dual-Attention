...
sampling_rate=500
checkpoint_path = "/home/engs2522/project/multi-modal-heart/multi_modal_heart/tasks/finetune_on_HF/ECG_attention_512_raw_no_attention_pool_no_linear_ms_resnet/checkpoints/final.pt"
...
classification_net = LitClassifier(encoder=ecg_net.encoder,input_dim=512,num_classes=2)
...
mm_checkpoint = torch.load(checkpoint_path)
classification_net.load_state_dict(mm_checkpoint)
